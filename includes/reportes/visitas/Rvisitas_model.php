...
function reporteVisitas() {
    ...
    $retval='<div class="botonesSuperiores">
            ...
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="jarviswidget" id="wid-id-2" data-widget-editbutton="false" >
                        ...
                        <div id="listaReporteVisitasVer">
                                <table id="listaVisitas" class="table table-striped table-bordered table-hover" width="100%">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th><i class="fa fa-fw fa-user txt-color-blue hidden-md hidden-sm hidden-xs"></i> Fecha de visita</th>
                                        <th><i class="fa fa-fw fa-lock txt-color-blue hidden-md hidden-sm hidden-xs"></i> Hora de ingreso</th>
                                        <th><i class="fa fa-fw fa-map-marker txt-color-blue hidden-md hidden-sm hidden-xs"></i> Hora de salida</th>
                                        <th><i class="fa fa-fw fa-map-marker txt-color-blue hidden-md hidden-sm hidden-xs"></i> Nombre visitante</th>
                                        <th><i class="fa fa-fw fa-map-marker txt-color-blue hidden-md hidden-sm hidden-xs"></i> Cédula visitante</th>
                                        <th><i class="fa fa-fw fa-map-marker txt-color-blue hidden-md hidden-sm hidden-xs"></i> Pabellón</th>                                        
                                        <th><i class="fa fa-fw fa-map-marker txt-color-blue hidden-md hidden-sm hidden-xs"></i> Nombre de PPL</th>                                        
                                        <th><i class="fa fa-fw fa-map-marker txt-color-blue hidden-md hidden-sm hidden-xs"></i> Cédula PPL</th>                                        
    ...
    while ($row = $val->fetch_object()){
     ...
     $retval .=reporteVisitasExcel($fdesde,$fhasta);
        echo $retval;

}

function reporteVisitasExcel($fdesde,$fhasta) {
    global $dbmysql;
    $retval='<div id="listaReporteVisitas">
                <h2>Reporte de Visitas entre el: '.$fdesde.' hasta el '.$fhasta.' </h2>
                <table id="listaVisitas" class="table table-striped table-bordered table-hover" width="100%">
                <thead>
                    <tr>
