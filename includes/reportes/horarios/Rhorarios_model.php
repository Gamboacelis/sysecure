            ...
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="jarviswidget" id="wid-id-2" data-widget-editbutton="false" >
                    ...
                    $sql = "SELECT pab.CEN_COD,p.`PPL_COD`,e.NVL_COD, e.NVL_DESCRIPCION,p.`PAB_COD`,pab.PAB_DESCRIPCION,pab.PAB_ALA,p.`PPL_NOMBRE`,p.`PPL_APELLIDO`,p.`PPL_CEDULA`,p.`PPL_NACIONALIDAD`
                            ...
                            WHERE e.NVL_COD=pab.NVL_COD AND pab.`PAB_COD`=p.`PAB_COD` AND pab.CEN_COD=$centro AND e.NVL_COD= $nivel;";
...
function consultahijo($pabellon){
    ...
    if($val2->num_rows>0){
                        $retval .='<table class="table table-striped table-bordered table-hover" width="100%">
                                        <thead>
                                            <tr>
