    ...
    $retval = '<div class="row">
                ...
                <div class="col-sm-12">
                    <ul id="myTab1" class="nav nav-tabs bordered">
                            <li class="active">
                                    <a href="#s1" data-toggle="tab">Datos Generales <i class="fa fa-caret-down"></i></a>
                            </li>
                            <li>
                                    <a href="#s2" data-toggle="tab">PPL</a>
                            </li>
                            <li>
                                    <a href="#s3" data-toggle="tab">Historial de Visitas</a>
                            </li>
                            <li class="pull-right hidden-mobile">
                                    <a href="javascript:void(0);"> <span class="note">'.$val->num_rows.' resultados (0.15 segundos) </span> </a>
                            </li>
                    </ul>
                    <div id="myTabContent1" class="tab-content bg-color-white padding-10">
                         ...
                         $retval .= '<div class="tab-pane fade" id="s2">
