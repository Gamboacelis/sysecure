...
global $dbmysql;
        $aColumns = array('PPL_COD','PPL_COD','PAB_COD','PAB_DESCRIPCION','CEL_COD','PPL_NOMBRE','PPL_APELLIDO','PPL_CEDULA','PPL_IMG','PPL_ESTADO','HOR_FECHA');
	/* Campo de Index */
...
//	}
	 ...
	 * Get data to display
	 */
	//$condicion = " CASE `HOR_DIAS` WHEN 'LUNES' THEN 'Monday' WHEN 'MARTES' THEN 'Tuesday' WHEN 'MIERCOLES' THEN 'Wednesday' WHEN 'JUEVES' THEN 'Thursday' WHEN 'VIERNES' THEN 'Friday' WHEN 'SABADO' THEN 'Saturday' WHEN 'DOMINGO' THEN 'Sunday' END = DAYNAME(CURDATE())";
    $condicion = "HOR_FECHA = '".date("Y-m-d")."'";
