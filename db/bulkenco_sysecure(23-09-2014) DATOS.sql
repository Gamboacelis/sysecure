...
--
-- Servidor: localhost
-- Tiempo de generación: 23-09-2014 a las 16:37:19
...
(1, 1, 1, 3, '2014-09-22', 'A'),
(2, 2, 1, 3, '2014-09-22', 'S'),
(3, 3, 1, 3, '2014-09-22', 'A');
...
(3, 1, 1, '4', 'MARTES', '08:00:00', '23:59:00', 'A');
...
(3, 'JESSICA ESTEFANÍA', 'ARCOS GONZÁLEZ', '', '', '2425477', '', '', 'N'),
...
CREATE TABLE IF NOT EXISTS `sys_visitante_ppl` (
  ...
  PRIMARY KEY (`VIP_COD`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Listado de Visitantes que se encuentran ligados a un PPL' AUTO_INCREMENT=3 ;
...
--
-- en uso(#1356 - View 'bulkenco_sysecure.sys_vw_control3' references invalid table(s) or column(s) or function(s) or definer/invoker of view lack rights to use them)
...
(1, 1, 'FABIÁN GUSTAVO', 'ARCOS PEPINOS', 1, 'A', 'Ecuatoriana', '', 4, 'HIJA', 3, 'JESSICA ESTEFANÍA', 'ARCOS GONZÁLEZ', '', '', '2425477', '', '', 'N');
