...
--
-- Servidor: localhost
-- Tiempo de generación: 06-09-2014 a las 00:12:48
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Tabla de control de Accesos al Sistema' AUTO_INCREMENT=8 ;
...
(7, 1, 1, '2014-09-05 17:32:15', '::1', 'Willian-PC');
...
(1, 1, 3, 7, '2014-09-05', 'S'),
(2, 1, 4, 7, '2014-09-05', 'S'),
(3, 2, 3, 7, '2014-09-05', 'A'),
(4, 2, 4, 7, '2014-09-05', 'S'),
(5, 3, 3, 0, '2014-09-05', 'S'),
(6, 3, 4, 7, '2014-09-05', 'A');
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Datos de horarios que pueden tener los pabellones para las v' AUTO_INCREMENT=8 ;
...
(3, 1, 1, 'Horaio en la Tarde', 'Jueves', '01:00:00', '13:40:00', 'A'),
...
(7, 1, 1, 'Horario familiar', 'Viernes', '16:00:00', '18:00:00', 'A');
...
(2, 1, 'VISITANTES', 'Cantidad de Visitas por horario', '2'),
...
(2, 'Mariana José', 'Figueroa Ramirez', 18, '1720802394', 'calderon', '3811694', '', '', 'A'),
(3, 'Pedro Juaquin', 'Suarez Figueroa', 1, '1720802394', 'calderon', '3811697', '', '', 'A'),
(4, 'Maria Emilia', 'Claudia Garcia', 2, '1720802394', 'Calderon', '3811687', '', '', 'S'),
(5, 'Jose Marco', 'Medina Coronel', 1, '1720802394', 'Calderon', '3811975', '', '', 'S'),
(7, 'Jose Luis', 'Perez Perez', 1, '1720802394', 'Calderon', '3811654', '', '', 'A'),
(8, 'Marco Vinicio', 'yanez Montalvo', 19, '1720802394', 'Calderon', '3811321', '', '', 'A'),
(9, 'Christian Andres', 'Marcayata Montalvo', 1, '1720802394', 'calderon', '3659874', '', '', 'A');
...
(1, 2, 4, 1, 'Cualqueir cosa', '2014-09-05 00:00:00', '2014-11-04');
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Registro de Visitas realizadas' AUTO_INCREMENT=2 ;
...
(1, 4, 4, 7, '2014-09-05', '17:21:00', '18:00:00', '00:02:00', 'A', 1, 'T');
...
--
ALTER TABLE `sys_accesos`
MODIFY `ACC_COD` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Codigo de Acceso',AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `sys_control`
MODIFY `CON_COD` int(11) NOT NULL AUTO_INCREMENT COMMENT 'codigo del Control',AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `sys_horarios`
MODIFY `HOR_COD` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Codigo del Horario',AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `sys_visitas`
MODIFY `VISG_COD` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Codigo de la Visita',AUTO_INCREMENT=2;
--
